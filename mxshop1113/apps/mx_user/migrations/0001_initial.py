    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', '男'), ('famale', '女')], default='male', max_length=15, verbose_name='年龄')),
                ('email', models.EmailField(blank=True, max_length=50, null=True, verbose_name='电子邮箱')),
